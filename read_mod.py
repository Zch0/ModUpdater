...
def extract_mod_source_url(sourceURL_from: List[str], mod_config: dict) -> Optional[str]:
...
def extract_mod_name(mod_config: dict) -> Optional[str]:
    return mod_config.get("name", None)

def extract_mod_version(mod_config: dict) -> Optional[str]:
